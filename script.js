...
const translate = window.TrueLiftI18n?.t || ((text) => text);

const screens = [
  {
    label: translate("Registro"),
    src: "Screenshot_2026-07-04-19-16-02-551_es.rubensoro.truelift.jpg",
    alt: translate("Registro de rutina con recomendación de carga y estado para entrenar"),
  },
  {
    label: translate("Registro · RIR"),
    src: "Screenshot_2026-07-04-19-15-09-688_es.rubensoro.truelift.jpg",
    alt: translate("Registro de rutina con consolidación de carga por RIR inferior al objetivo"),
  },
  {
    label: translate("Autorregulación"),
    src: "Screenshot_2026-07-04-19-15-31-412_es.rubensoro.truelift.jpg",
    alt: translate("Formulario de autorregulación diaria con sueño, energía, estrés, dolor articular y VFC"),
  },
  {
    label: translate("Progreso · Informe"),
    src: "Screenshot_2026-07-04-19-13-40-804_es.rubensoro.truelift.jpg",
    alt: translate("Informe mensual con disponibilidad reciente, estado para entrenar y rendimiento de sesión"),
  },
  {
    label: translate("Progreso · VFC"),
    src: "Screenshot_2026-07-04-19-13-36-841_es.rubensoro.truelift.jpg",
    alt: translate("Pantalla de progreso con rendimiento neto diario, VFC por día y marcas personales"),
  },
  {
    label: translate("Progreso · Tonelaje"),
    src: "Screenshot_2026-07-04-19-14-22-056_es.rubensoro.truelift.jpg",
    alt: translate("Pantalla de progreso con tonelaje por sesión y 1RM estimado por ejercicio"),
  },
  {
    label: translate("Progreso · e1RM"),
    src: "Screenshot_2026-07-04-19-14-10-994_es.rubensoro.truelift.jpg",
    alt: translate("Pantalla de progreso con evolución del e1RM estimado y repeticiones totales por sesión"),
  },
  {
    label: translate("Volumen"),
    src: "Screenshot_2026-07-04-19-16-18-341_es.rubensoro.truelift.jpg",
    alt: translate("Pantalla de volumen semanal con series efectivas y frecuencia por grupo muscular"),
  },
  {
    label: translate("Rutina PRO"),
    src: "Screenshot_2026-07-04-19-16-35-066_es.rubensoro.truelift.jpg",
    alt: translate("Pantalla de rutina PRO con importación, exportación, creación de ejercicios y personalización"),
  },
];
